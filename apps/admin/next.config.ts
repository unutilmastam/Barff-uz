 ...
 * Admin CMS.
 *
 * `apps/web` bilan bir xil yondashuv: `phase` bo'yicha qaror (muhit
...
export default function config(phase: string): NextConfig {
  ...
  return {
    ...
    /**
     * Admin panel qidiruv tizimlariga UMUMAN tushmasligi kerak.
     *
     * Bu `robots.txt` dan ham kuchliroq: sarlavha har bir javobda
     * keladi va uni chetlab o'tib bo'lmaydi.
     */
    async headers() {
      return [
        {
          ...
          headers: [
            ...
            // Admin sahifasi hech qachon `<iframe>` ichiga solinmasligi
            // kerak — clickjacking'ning eng oddiy yo'li.
