 ...
 * ochardi.
 *
 * TASDIQLANMAGAN diler ham KIRA OLADI — va bu ataylab: u o'z
 * arizasi holatini ko'rishi kerak (S22). Ishlash huquqi kirishda
 * emas, har bir endpoint'da tekshiriladi.
 */
